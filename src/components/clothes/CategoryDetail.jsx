...
import CateCard from '../books/small/CateCard';
...
const fetchData = async () => {
      try {
        const response = await fetch(`http://localhost:4002/api/ecomSys/book/category/${id}/`);
  ...
  const handleDeleteBook = async (id) => {
    ...
    try {
      const response = await fetch(`http://localhost:4002/api/ecomSys/book/delete/${id}/`, {
        method: 'DELETE',
        headers: {
